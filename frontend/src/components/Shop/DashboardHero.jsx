  ...
  const columns = [
...

    {
      ...
      cellClassName: (params) => {
        // Check if params and params.getValue are defined
        if (params && params.getValue) {
          // Check if params.id and params.status are defined
          const status = params.getValue(params.id, "status");
          return status === "Delivered" ? "greenColor" : "redColor";
        }
        // Return a default class if params or params.getValue are not defined
        return "";
      },
    },
    {
